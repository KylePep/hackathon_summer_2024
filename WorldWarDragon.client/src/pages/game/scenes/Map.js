...
export class Map extends Scene {
    ...
    createButtons() {
        ...
        this.bottomRightButton = this.add.text(0, 0, 'Boghir', {
            ...
            stroke: '#000000', strokeThickness: 8,
            align: 'center'
        }).setOrigin(1, 0).setInteractive().on('pointerdown', () => this.buttonAction('Bottom Right', 4)).on('pointerover', () => this.buttonOver(this.bottomRightButton)).on('pointerout', () => this.buttonOut(this.bottomRightButton));
